...
public class ServerConfig {
    ...
    public static final ModConfigSpec.IntValue ROUND_SECONDS = BUILDER.comment("The duration in seconds for timed rounds to last").defineInRange("roundSeconds", 600, 15, 1800);
    public static final ModConfigSpec.IntValue TARGET_SCORE = BUILDER.comment("The target score for score rounds").defineInRange("targetScore", 15, 1, 1000);
    ...
    public static final ModConfigSpec.BooleanValue ALLOW_BLOCKS = BUILDER.comment("Whether team blocks can be placed").define("allowBlocks", true);
