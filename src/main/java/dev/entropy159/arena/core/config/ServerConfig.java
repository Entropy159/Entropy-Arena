...
public class ServerConfig {
    ...
    public static final ModConfigSpec.IntValue DEFAULT_ROUND_SECONDS = BUILDER.comment("The duration in seconds for timed rounds to last").defineInRange("defaultRoundSeconds", 600, 15, 1800);
    public static final ModConfigSpec.IntValue DEFAULT_TARGET_SCORE = BUILDER.comment("The target score for score rounds").defineInRange("defaultTargetScore", 15, 1, 1000);
